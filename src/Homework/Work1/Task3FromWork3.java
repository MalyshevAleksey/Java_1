...
import static Homework.Work1.Task2FromWork3.sumElementsColumns;
public class Task3FromWork3 {
    public static void main(String[] args) {
        ...
        int [] resultAllParties = applicationWork3Task3.allResult(Task2FromWork3.sumElementsColumns(array, false),
                Task1FromWork3.sumElementsRows(array, false),
